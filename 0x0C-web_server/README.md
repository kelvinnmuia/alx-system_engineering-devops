...
```
  ...
  * [1-install_nginx_web_server](./1-install_nginx_web_server): Bash script that configures nginx to a new ubuntu machine.
...
.TECH Domains worked with domain name registrars to give you access to a free domain name for a year. Please get the promo 
code in your tools space. Feel free to drop a thank you tweet for .TECH Domains.
...
see in the JSON response: `"registrarName": "Dotserve Inc"`
  ...
  * [2-setup_a_domain_name](./2-setup_a_domain_name): File that contains the domain name
...
* You answer file should be a Bash script containing commands to automatically configure a Ubuntu machine 
...
sylvain@ubuntu$
```
  * [3-redirection](./3-redirection): Bash script for redirection to another page
...
* Using what you did with `3-redirection`, write `4-not_found_page_404` so that it configures a brand new 
Ubuntu machine to the requirements asked in this task
