...
In this project I learned how to create puppet scripts to automate the processes of web stack debugging. At the end of the project I created a puppet script to fix the 500 error from the web server.
