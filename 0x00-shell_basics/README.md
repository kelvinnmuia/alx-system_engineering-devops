1.0-current_working_directory: print the absolute path of current working directory
...
20.school.mgc: Creates a magic file school.mgc that can be used with the command file to detect School data files
