...
```
  ...
  * [0-nginx_likes_port_80](./0-nginx_likes_port_80): Bash script that fixes the port 80 in nginx web server
...
```
  ...
  * [1-debugging_made_short](./1-debugging_made_short): Shortened Version of the first bash script
...
* [Web stack debugging](https://docs.google.com/document/d/10LuLZ9sUHDBz5VYVrf3jLqUx4KUkZz_u2_9I3gVD1Sc/edit?usp=sharing)
